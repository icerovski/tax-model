...
- Strengthen the "Commercial Substance" narrative by explicitly stating the consulting service is specialized "US PV/BESS market research".
...
- **docs/requests/tax_request_bulgaria.md**: 
    ...
    - Added specific PV/BESS market research context to validate the 25% statutory deduction and mitigate hidden-employment scrutiny.
...
- **docs/requests/tax_request_usa.md**:
    - Rewritten in the first person.
    - Added the PV/BESS research context to confirm it does not trigger an ETBUS (Engaged in Trade or Business in the US) nexus.
