# Request for Professional Tax Advice: British Virgin Islands (BVI)
**Project:** BVI Business Company (BC)
**Profile:** Bulgarian Resident Beneficial Owner.
...
## 3. Scope of Inquiry: Privacy & Disclosure
*   **BOSS Act:** Confirm the reporting requirements under the **Beneficial Ownership Secure Search System (BOSS) Act**. Who has access to this data, and is it shared with the Bulgarian NRA?
*   **CRS/AEOI:** Confirm that the BVI participates in the **Common Reporting Standard (CRS)**. Confirm that the BVI will automatically share account balances and beneficial ownership info with Bulgaria.
